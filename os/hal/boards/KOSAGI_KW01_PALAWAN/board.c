  ...
  .ports = {
    ...
    },
    {
      ...
      .pads = {
        ...
        /* PTD3*/ PAL_MODE_UNCONNECTED,     /* PTD4*/ PAL_MODE_INPUT,           /* PTD5*/ PAL_MODE_OUTPUT_PUSHPULL,
        /* PTD6*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTD7*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTD8*/ PAL_MODE_UNCONNECTED,
    ...
    },
    {
      .port = IOPORT5,  // PORTE
      .pads = {
        /* PTE0*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTE1*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTE2*/ PAL_MODE_UNCONNECTED,
